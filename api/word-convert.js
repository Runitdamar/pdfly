...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Step 2 — Start task (officepdf = Word/Office → PDF)
    ...
    const mimeType = isDocx ? 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' : 'application/msword';
